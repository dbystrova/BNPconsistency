...
#rm(list=ls())
#setwd("~/Documents/GitHub/BNPapprox")
library(inline)
library(rbenchmark)
library(frailtySurv)
library(rust)
...
#A = Prior_on_K_PYM(0.18, 0.75, 50, 100,10000)
# 
...
gibbs.H <- function(n.iter=500, H, sigma, n )
{
