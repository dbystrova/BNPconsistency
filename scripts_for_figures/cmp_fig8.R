...
ds_list<- c("~/Documents/GitHub/BNPconsistency/scripts_for_figures/sim_data/GM_3_100.RData","~/Documents/GitHub/BNPconsistency/scripts_for_figures/sim_data/GM_3_1000.RData",
...
df_8 <-comparison_n(ds_list, alpha = 2,K_ = 10, M_it= 10000 , nburn = 2000)
save(df_8, file = "~/Documents/GitHub/BNPconsistency/saves_for_figures/cmp_fig8.RData")
