...
alpha_list<- c(0.01, 0.005, 0.002, 0.001)
...
df_11<-comparison_n_2(ds_list,K_ = 10, M_it= 10000 , nburn = 2000,alpha_l = alpha_list)
save(df_11, file = "~/Documents/GitHub/BNPconsistency/saves_for_figures/cmp_fig11.RData")
