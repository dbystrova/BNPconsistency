...
pk_n_500 = MCMC_function(data_500, e0=alpha_2, K=K_nc, M=M_it, burnin=burnin_) 
pk_n_1500 = MCMC_function(data_1500, e0=alpha_2, K=K_nc, M=M_it, burnin=burnin_) 
pk_n_5000 = MCMC_function(data_5000, e0=alpha_2, K=K_nc, M=M_it, burnin=burnin_) 
