...
burnin_ <- 20
K_nc <- 9
pk_n_10 = MCMC_function(data_10, e0=alpha_3, K=K_nc, M=M_it, burnin=burnin_) 
K_nc <- 10
pk_n_100 = MCMC_function(data_100, e0=alpha_3, K=K_nc, M=M_it, burnin=burnin_) 
pk_n_1000 = MCMC_function(data_1000, e0=alpha_3, K=K_nc, M=M_it, burnin=burnin_) 
...
save(df2_, file = "~/Documents/GitHub/BNPconsistency/saves_for_figures/cmp_fig6_2.RData")
