...
df_$Rh =  c(rep(pk_n_10$ll_rhat,length( pk_n_10$p_k)+1), rep(pk_n_100$ll_rhat,length( pk_n_100$p_k)),rep(pk_n_1000$ll_rhat,length( pk_n_1000$p_k)),rep(pk_n_10000$ll_rhat,length( pk_n_10000$p_k)))
...
df2_$Rh =  c(rep(pk_n_10$ll_rhat,length( pk_n_10$p_k)+1), rep(pk_n_100$ll_rhat,length( pk_n_100$p_k)),rep(pk_n_1000$ll_rhat,length( pk_n_1000$p_k)),rep(pk_n_10000$ll_rhat,length( pk_n_10000$p_k)))
