...
K_nc <- 9
pk_n_10 = MCMC_function(data_10, e0=alpha_4, K=K_nc, M=M_it, burnin=burnin_) 
K_nc <- 10
pk_n_100 = MCMC_function(data_100, e0=alpha_4, K=K_nc, M=M_it, burnin=burnin_) 
pk_n_1000 = MCMC_function(data_1000, e0=alpha_4, K=K_nc, M=M_it, burnin=burnin_) 
pk_n_10000 = MCMC_function(data_10000, e0=alpha_4, K=K_nc, M=M_it, burnin=burnin_) 
...
df_$alpha = c(rep(alpha_4,K_nc),rep(alpha_4,K_nc),rep(alpha_4,K_nc),rep(alpha_4,K_nc))  
...
save(df2_, file = "~/Documents/GitHub/BNPconsistency/saves_for_figures/cmp_fig7_2.RData")
