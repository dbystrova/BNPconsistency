...
df_10<-comparison_n_2(ds_list,K_ = 10, M_it= 10000 , nburn = 2000,alpha_l = alpha_list)
save(df_10, file = "~/Documents/GitHub/BNPconsistency/saves_for_figures/cmp_fig10.RData")
